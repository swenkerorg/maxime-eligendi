[![npm](https://img.shields.io/npm/v/@swenkerorg/maxime-eligendi.svg)](https://www.npmjs.com/package/@swenkerorg/maxime-eligendi) ![downloads](https://img.shields.io/npm/dt/@swenkerorg/maxime-eligendi.svg) [![CI](https://github.com/swenkerorg/maxime-eligendi/actions/workflows/ci.yml/badge.svg)](https://github.com/swenkerorg/maxime-eligendi/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@swenkerorg/maxime-eligendi/renderer](https://www.npmjs.com/package/@@swenkerorg/maxime-eligendi/renderer).

## tl;dr

- Install by executing `npm install @swenkerorg/maxime-eligendi` or `yarn add @swenkerorg/maxime-eligendi`.
- Import by adding `import { Document } from '@swenkerorg/maxime-eligendi'`.
...
[Online demo](https://projects.wojtekmaj.pl/@swenkerorg/maxime-eligendi/) is also available!
...
- [v7.x](https://github.com/swenkerorg/maxime-eligendi/blob/v7.x/packages/@swenkerorg/maxime-eligendi/README.md)
- [v6.x](https://github.com/swenkerorg/maxime-eligendi/blob/v6.x/README.md)
- [v5.x](https://github.com/swenkerorg/maxime-eligendi/blob/v5.x/README.md)
- [v4.x](https://github.com/swenkerorg/maxime-eligendi/blob/v4.x/README.md)
- [v3.x](https://github.com/swenkerorg/maxime-eligendi/blob/v3.x/README.md)
- [v2.x](https://github.com/swenkerorg/maxime-eligendi/blob/v2.x/README.md)
- [v1.x](https://github.com/swenkerorg/maxime-eligendi/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @swenkerorg/maxime-eligendi` or `yarn add @swenkerorg/maxime-eligendi`.
...
```ts
import { pdfjs } from '@swenkerorg/maxime-eligendi';
...
import { Document, Page } from '@swenkerorg/maxime-eligendi';
...
Check the [sample directory](https://github.com/swenkerorg/maxime-eligendi/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/swenkerorg/maxime-eligendi/wiki/Recipes) in [React-PDF Wiki](https://github.com/swenkerorg/maxime-eligendi/wiki/).
...
```ts
import '@swenkerorg/maxime-eligendi/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@swenkerorg/maxime-eligendi/dist/Page/TextLayer.css';
```
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@swenkerorg/maxime-eligendi__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@swenkerorg/maxime-eligendi__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@swenkerorg/maxime-eligendi__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@swenkerorg/maxime-eligendi__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/swenkerorg/maxime-eligendi/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@swenkerorg/maxime-eligendi-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@swenkerorg/maxime-eligendi/contributors.svg?width=890&button=false)
